...
export default function Index({ transactions, categories }) {
    ...
    return (
        <AuthenticatedLayout
            header={
                <h2 className="text-xl font-semibold leading-tight text-gray-900 dark:text-gray-200">
                    Data Transaksi
                </h2>
            }
        >
            ...
            <div className="p-8">
                <div className='flex justify-between items-center mb-6'>
                    <Link href="/transaction/create" className="bg-gray-200 dark:bg-gray-800 shadow-sm font-semibold text-gray-800 dark:text-white px-6 py-3 rounded">
                        Tambah Transaksi
                    </Link>
                    ...
                    <table className="min-w-full text-sm bg-white text-gray-800 dark:bg-gray-800 dark:text-gray-200">
                        <thead className="bg-gray-200 dark:bg-gray-700 text-xs uppercase font-medium p-4">
                            <tr>
                                ...
                                <th className="px-6 py-3 text-left tracking-wider">Aksi</th>
                            </tr>
                        </thead>
                        <tbody>
